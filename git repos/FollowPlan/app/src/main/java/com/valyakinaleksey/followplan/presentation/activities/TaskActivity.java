...
import com.valyakinaleksey.followplan.domain.adapters.SpinnerPeriodArrayAdapter;
import com.valyakinaleksey.followplan.domain.adapters.SpinnerPlanArrayAdapter;
...
import static com.valyakinaleksey.followplan.presentation.dialogs.TimePreference.*;
import static com.valyakinaleksey.followplan.util.Constants.*;
...
public class TaskActivity extends AppCompatActivity implements ISimpleDialogListener, DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void initDateTimeNotification(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            dateNotification = (DateTime) savedInstanceState.getSerializable(Constants.DATE_NOTIFICATION);
        ...
        if (dateNotificationSet) {
            ...
            tvDateNotification.setText(dateNotification.toString(DD_MM_YYYY));
        }
